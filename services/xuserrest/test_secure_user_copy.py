...
#     def _setup(self, request, ranger_session, default_headers):

#         create_user = request.getfixturevalue("temp_secure_user")
#         create_keyadmin = request.getfixturevalue("temp_keyadmin_user")

#         self.admin, self.ranger_admin_id = create_user(["admin"], session=ranger_session)
#         self.audit, self.ranger_auditor_id = create_user(["auditor"], session=ranger_session)
#         self.user, self.ranger_user_id = create_user(["user"], session=ranger_session)
#         self.ranger_key_admin, self.ranger_key_admin_id = create_keyadmin(session=ranger_session)


#         self.admin1, self.ranger_admin_id1 = create_user(["admin"], session=ranger_session)
#         self.audit1, self.ranger_auditor_id1 = create_user(["auditor"], session=ranger_session)
#         self.user1, self.ranger_user_id1 = create_user(["user"], session=ranger_session)
#         self.ranger_key_admin1, self.ranger_key_admin_id1 = create_keyadmin(session=ranger_session)

    
#         self.session = ranger_session
...
#         init_configs(
#             self.ranger_admin_config,
#             self.ranger_key_admin_config,
#             self.ranger_auditor_config,
#             self.ranger_user_config
#         )
